...
X_train, Y_train, X_test, Y_test = amazon_reviews()
...
#print(heapq.nlargest(5, A, key=A.get))
#import sys
#sys.exit()
...
for y_label in y_labels:
    ...
    p = precision(predicted_Y, Y_test, y_label)
    print (p)

    r = recall(predicted_Y, Y_test, y_label)
    print (r)
